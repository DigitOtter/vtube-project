...
func _init_gui():
	# Toggle Shading
	var ascii_toggle: GuiElements.ElementData = GuiElements.ElementData.new()
	...
	var ascii_toggle_data: GuiElements.CheckBoxData = GuiElements.CheckBoxData.new()
	ascii_toggle_data.Default = false
	ascii_toggle.Data = ascii_toggle_data
	
	# Toggle Color
	var color_toggle: GuiElements.ElementData = GuiElements.ElementData.new()
	...
	var color_toggle_data: GuiElements.CheckBoxData = GuiElements.CheckBoxData.new()
	color_toggle_data.Default = self._color_enabled
	color_toggle.Data = color_toggle_data
	
	# Set _pixelization
	var pixelization_range: GuiElements.ElementData = GuiElements.ElementData.new()
	...
	var pixelization_range_data: GuiElements.SliderData = GuiElements.SliderData.new()
	...
	var tab_elements: Array[GuiElements.ElementData] = [ascii_toggle, color_toggle, pixelization_range]
